...
class TelegramAPI:
    ...
    def send_message_sync(self, token: str, chat_id: int, text: str, keyboard: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    def answer_callback_query_sync(self, token: str, callback_query_id: str, text: str = "") -> Dict[str, Any]:
    ...
    def edit_message_sync(self, token: str, chat_id: int, message_id: int, text: str, keyboard: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        with httpx.Client() as client:
            response = client.post(
                f"{self.BASE_URL}{token}/editMessageText",
                json=payload
            )
            response.raise_for_status()
            return response.json()
